...
export default function Properties() {
  ...
  const cities = [
    {
      name: "Abu Dhabi",
      description: "Capital City - Prime Commercial & Residential Portfolio",
      properties: [
        {
          id: "ad-1",
          ...
          type: "Residential",
          description: "Stunning views, modern finishes, sea views with pools, gym, and children's play area.",
        ...
        },
        {
          ...
          type: "Residential",
          description: "2 and 3-bedroom apartments with all modern amenities.",
        ...
        },
        {
          ...
          type: "Commercial",
          description: "Office and commercial spaces including luxury offices, showrooms, and co-working spaces.",
          image: propertyImages.commercial,
        },
        {
          id: "ad-4",
          name: "DHHG Building",
          location: "Mussafah M44",
          type: "Industrial",
          description: "Industrial and commercial hub with warehouses, retail spaces, and labor accommodation.",
        ...
        },
        {
          ...
          type: "Commercial",
          description: "Retail units and showrooms in prime location.",
          image: propertyImages.commercial,
        },
        {
          id: "ad-6",
          ...
          location: "Mussafah M44",
          type: "Industrial",
          description: "Warehouses, retail spaces, labor accommodation, and showrooms.",
          image: propertyImages.industrial,
        },
        {
          id: "ad-7",
          name: "HS Investments",
          location: "ICAD-3 Industrial Hub",
          type: "Industrial",
          description: "Warehouses, industrial land, marine activity land, yacht stations, drydocking, and maintenance facilities.",
          image: propertyImages.industrial,
        },
      ],
    },
      ...
      properties: [
        {
          ...
          location: "Industrial area near Bawadi Mall",
          type: "Industrial",
          description: "Retail units and warehouses in premium industrial location.",
          image: propertyImages.industrial,
        },
        {
          id: "aa-2",
          ...
          type: "Industrial",
          description: "Labor accommodation and warehouses.",
          image: propertyImages.industrial,
        },
        {
          id: "aa-3",
          ...
          location: "Industrial area",
          type: "Industrial",
          description: "Labor accommodation facilities.",
          image: propertyImages.industrial,
        },
        {
          id: "aa-4",
          ...
          location: "Industrial area",
          type: "Industrial",
          description: "Labor accommodation, warehouses, showrooms, and retail units.",
          image: propertyImages.industrial,
        },
        {
          id: "aa-5",
          ...
          location: "Industrial area",
          type: "Industrial",
          description: "Labor accommodation services.",
          image: propertyImages.industrial,
        },
        {
          id: "aa-6",
          name: "Sheikh Hamad Building",
          location: "Al Saniya, Al Ain",
          type: "Mixed-Use",
          description: "Offices, accommodation, and retail units.",
          image: propertyImages.commercial,
        },
        {
          id: "aa-7",
          name: "Al Jimi Villas (No. 89, 115, 117, 119)",
          location: "Near Al Jimi Mall",
          type: "Residential",
          description: "Staff and family accommodation villas.",
        ...
        },
        {
          ...
          location: "Near Al Jimi Mall",
          type: "Residential",
          description: "Staff and family accommodation.",
          image: propertyImages.villa,
        },
        {
          id: "aa-10",
          name: "Falah Al Oraibi Villa (No. 48, 50)",
          location: "Town Center",
          type: "Residential",
          description: "Staff and family accommodation in central location.",
          image: propertyImages.villa,
        },
        {
          id: "aa-11",
        ...
        {
          id: "aa-12",
          name: "Al Ameerah Complex (No. 58)",
          location: "Al Ameerah",
          type: "Commercial",
          description: "Retail units in premium location.",
          image: propertyImages.commercial,
        },
      ],
    },
    {
      name: "Dubai",
      description: "Metropolitan Hub - Diverse Property Portfolio",
      properties: [
        {
          id: "db-1",
          name: "NR Building",
          ...
          type: "Residential",
          description: "Residential flats with G+4 floors, modern amenities and facilities.",
          image: propertyImages.apartments,
        },
        {
          id: "db-2",
          ...
          type: "Mixed-Use",
          description: "Residential apartments and retail units with G+6 + Roof.",
          image: propertyImages.apartments,
        },
        {
          id: "db-3",
          ...
          location: "Al Warqa-1 Dubai",
          type: "Residential",
          description: "Residential apartments with G+6 + Roof floors.",
          image: propertyImages.apartments,
        },
        {
          id: "db-4",
          name: "NR Building",
          location: "Al Warsan-4 Dubai",
          type: "Residential",
          description: "Residential apartments with G+4 floors.",
          image: propertyImages.apartments,
        },
        {
          id: "db-5",
          ...
          type: "Commercial",
          description: "Commercial offices and retail units with G+8 floors in premium business district.",
          image: propertyImages.commercial,
        },
      ],
    },
